...
target/score-display.rolldown.js: node_modules $(wildcard score-display/*) patches/score-display.rolldown.js.no-cdn.diff
	mkdir -p target
...
target/score-display.rolldown.no-mm.js: node_modules score-display/score-display.global.js patches/score-display.global.js.no-mm.diff
	mkdir -p target
	cp score-display/score-display.global.js target/score-display.global.no-mm.js
	patch target/score-display.global.no-mm.js patches/score-display.global.js.no-mm.diff
	node_modules/.bin/rolldown target/score-display.global.no-mm.js --file target/score-display.rolldown.no-mm.js
	rm target/score-display.global.no-mm.js
